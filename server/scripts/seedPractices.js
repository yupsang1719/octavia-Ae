...
const practices = [
  ...
  },
  {
    ...
    whatsapp: '',
    type:    'mixed',
    tagline: 'NHS and private dental care in Hindhead, Surrey.',
    instagram: '',
    googleMapsUrl: 'https://maps.google.com/?q=New+Octavia+Dental+Surgery+Hindhead',
    metaTitle: 'New Octavia Dental Surgery | NHS & Private Dentist Hindhead',
    metaDesc:  'NHS and private dental care in Hindhead, Surrey. General dentistry, implants, cosmetic treatments and orthodontics.',
    hours: [
      { day: 'Monday',    hours: '9:00 am – 5:00 pm (closed 1–2 pm for lunch)', closed: false },
      { day: 'Tuesday',   hours: '9:00 am – 5:00 pm (closed 1–2 pm for lunch)', closed: false },
      { day: 'Wednesday', hours: '9:00 am – 5:00 pm (closed 1–2 pm for lunch)', closed: false },
