...
const practices = [
  ...
  },
  {
    ...
    hours: [
      { day: 'Monday',    hours: '9:00 am – 5:00 pm (closed 1–2 pm for lunch)', closed: false },
      { day: 'Tuesday',   hours: '9:00 am – 5:00 pm (closed 1–2 pm for lunch)', closed: false },
      { day: 'Wednesday', hours: '9:00 am – 5:00 pm (closed 1–2 pm for lunch)', closed: false },
      { day: 'Thursday',  hours: '9:00 am – 5:00 pm (closed 1–2 pm for lunch)', closed: false },
      { day: 'Friday',    hours: '9:00 am – 5:00 pm (closed 1–2 pm for lunch)', closed: false },
  ...
  },
  {
    ...
    whatsapp: '',
    type:    'private',
    tagline: 'Private dental care & facial aesthetics in Hindhead, Surrey.',
    instagram: '',
    googleMapsUrl: 'https://maps.google.com/?q=New+Octavia+Dental+Surgery+Hindhead',
    metaTitle: 'New Octavia Dental Surgery | Private Dentist Hindhead Surrey GU26',
    metaDesc:  'Private dental care in Hindhead, Surrey. Dental implants, Invisalign, cosmetic dentistry. No waiting list. New patients welcome from across Surrey and Hampshire.',
    hours: [
      { day: 'Monday',    hours: '9:00 am – 5:00 pm (closed 1–2 pm for lunch)', closed: false },
      { day: 'Tuesday',   hours: '9:00 am – 5:00 pm (closed 1–2 pm for lunch)', closed: false },
      { day: 'Wednesday', hours: '9:00 am – 5:00 pm (closed 1–2 pm for lunch)', closed: false },
