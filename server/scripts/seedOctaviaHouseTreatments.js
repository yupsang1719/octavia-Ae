...
const treatments = [
  {
    ...
    priceFrom: '£2,500',
    priceNote: 'Single implant from £2,500. Full treatment cost provided at consultation.',
    financeAvailable: true,
    h1: `Dental Implants in ${LOCATION}`,
    title: `Dental Implants ${LOCATION} Surrey | ${PRACTICE_NAME}`,
    metaDesc: `Expert dental implants in ${LOCATION}. Permanent tooth replacement from £2,500. Book an appointment.`,
    ...
    process: [
      { step: 1, title: 'Consultation', body: 'Our dentist assesses your bone density, gum health, and overall suitability. You receive a personalised treatment plan and transparent quote.' },
    ...
    faq: [
      ...
      { q: 'Am I a candidate for dental implants?', a: 'Most adults with good general health are suitable candidates. Our dentist will assess your bone density, gum health and overall oral health at your consultation.' },
      { q: 'How much do dental implants cost?', a: `A single dental implant at ${PRACTICE_NAME} starts from £2,500. We will provide a full personalised quote at your consultation.` },
  ...
  },
  {
    ...
    priceNote: 'Comprehensive cases typically £2,800–£5,000. Exact cost confirmed at consultation.',
    financeAvailable: true,
    h1: `Invisalign in ${LOCATION}`,
    title: `Invisalign ${LOCATION} Surrey | Clear Braces | ${PRACTICE_NAME}`,
    metaDesc: `Invisalign clear aligners in ${LOCATION}, Surrey. Book an appointment. Straighten your teeth without anyone knowing.`,
    ...
    process: [
      { step: 1, title: 'Consultation', body: 'Our dentist assesses your teeth, discusses your goals and confirms whether Invisalign is right for you.' },
    ...
    faq: [
      ...
      { q: 'How much does Invisalign cost?', a: `Invisalign at ${PRACTICE_NAME} is priced following your consultation. Comprehensive cases typically range from £2,800 to £5,000.` },
    ],
  },
  {
    ...
    priceNote: 'From £250 per tooth. Full smile makeovers from £1,800. Prices confirmed at consultation.',
    financeAvailable: false,
    h1: `Composite Bonding in ${LOCATION}`,
    title: `Composite Bonding ${LOCATION} Surrey | ${PRACTICE_NAME}`,
    metaDesc: `Composite bonding in ${LOCATION} from £250 per tooth. Same-day treatment, no drilling. Book an appointment.`,
    ...
    process: [
      { step: 1, title: 'Consultation', body: 'Our dentist discusses your smile goals and assesses your teeth, explaining what composite bonding can achieve and providing a clear quote.' },
    ...
    faq: [
      ...
      { q: 'How much does composite bonding cost?', a: `From £250 per tooth at ${PRACTICE_NAME}. Full quote provided at your consultation.` },
    ],
  },
  {
    slug: 'veneers',
    ...
    priceNote: 'From £800 per tooth. Full veneer cases from £4,800. Exact costs at consultation.',
    financeAvailable: true,
    h1: `Porcelain Veneers in ${LOCATION}`,
    title: `Porcelain Veneers ${LOCATION} Surrey | ${PRACTICE_NAME}`,
    metaDesc: `Porcelain veneers in ${LOCATION} from £800 per tooth. Natural-looking, long-lasting results. Book an appointment.`,
  ...
  },
  {
    ...
    priceFrom: '£2,000',
    priceNote: 'From £2,000 depending on complexity. Full quote provided at consultation.',
    financeAvailable: false,
    ...
    process: [
      { step: 1, title: 'Consultation', body: 'Our dentist assesses your teeth and bite and confirms whether 6 Month Smile is the right treatment.' },
